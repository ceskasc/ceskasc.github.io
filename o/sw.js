const CACHE='o-circle-v8-0';
const ASSETS=['./','./index.html','./styles.css?v=8.0','./retention.css?v=8.0','./progress.css?v=8.0','./rivals.css?v=8.0','./v7.css?v=8.0','./v8.css?v=8.0','./app.js?v=8.0','./app-core.js?v=8.0','./app-engine.js?v=8.0','./app-ui.js?v=8.0','./progress.js?v=8.0','./rivals.js?v=8.0','./v7.js?v=8.0','./v8.js?v=8.0','./config.js?v=8.0','./manifest.webmanifest','./icon.svg'];
