const CACHE='o-circle-v7-0';
const ASSETS=['./','./index.html','./styles.css?v=7.0','./retention.css?v=7.0','./progress.css?v=7.0','./rivals.css?v=7.0','./v7.css?v=7.0','./app.js?v=7.0','./app-core.js?v=7.0','./app-engine.js?v=7.0','./app-ui.js?v=7.0','./progress.js?v=7.0','./rivals.js?v=7.0','./v7.js?v=7.0','./config.js?v=7.0','./manifest.webmanifest','./icon.svg'];
